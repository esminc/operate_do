...
While the block is being executed, `OperateDo.current_operator` returns the current operator, the receiver of this method calling.
...
`flush!` method recive an array of `OperateDo::Message`.
